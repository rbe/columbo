...
public class HpSvDlvrDm implements Serializable {
    ...
    public HpSvDlvrDm(BigDecimal hpSvDlvrId) {
        this.hpSvDlvrId = hpSvDlvrId;
    }

    public HpSvDlvrDm(BigDecimal hpSvDlvrId, String caseId) {
        this.hpSvDlvrId = hpSvDlvrId;
        this.caseId = caseId;
    }

    public BigDecimal getHpSvDlvrId() {
        return hpSvDlvrId;
    }

    public void setHpSvDlvrId(BigDecimal hpSvDlvrId) {
        this.hpSvDlvrId = hpSvDlvrId;
    }
    ...
    public String toString() {
        return "eu.artofcoding.grownloader.columbo.entity.HpSvDlvrDm[ hpSvDlvrId=" + hpSvDlvrId + " ]";
    }
