...
public class OnsiteLogDm implements Serializable {
    ...
    private BigDecimal onsiteLogId;
    ...
    public OnsiteLogDm(BigDecimal onsiteLogId) {
        this.onsiteLogId = onsiteLogId;
    }

    public OnsiteLogDm(BigDecimal onsiteLogId, BigDecimal employeeTableId) {
        this.onsiteLogId = onsiteLogId;
        this.employeeTableId = employeeTableId;
    }

    public BigDecimal getOnsiteLogId() {
        return onsiteLogId;
    }

    public void setOnsiteLogId(BigDecimal onsiteLogId) {
        this.onsiteLogId = onsiteLogId;
    }
    ...
    public String toString() {
        return "eu.artofcoding.grownloader.columbo.entity.OnsiteLogDm[ onsiteLogId=" + onsiteLogId + " ]";
    }
