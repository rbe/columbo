...
public class TableCreator implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        try {
            ...
            logger.info(String.format("[%s] Truncating table", tableName));
            ...
            logger.info(String.format("[%s] Creating destination table through stored procedure %s, %s, %s (%s)", tableName, storedProc, schemaName, tableName, e.toString()));
